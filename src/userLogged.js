...
function saveUserToLS(email, nombreApellido, iconProfile, userId) {
...
function userIcon(selector) {
    ...
    if (!loggedInUser || !loggedInUser.iconProfile) { 
        ...
        userIcon.src=`${API_URL}/uploads/icon-default.png`
        return;
    }
